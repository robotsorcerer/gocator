...
GoFx(GoSpotSelectionType) GoMaterial_SpotSelectionTypeOptionAt(GoMaterial material, kSize index)
{
    ...
    kAssert(index < GoMaterial_SpotSelectionTypeOptionCount(material));

    return kArrayList_As_(obj->spotSelectionTypeOptions, index, GoSpotSelectionType);
}
