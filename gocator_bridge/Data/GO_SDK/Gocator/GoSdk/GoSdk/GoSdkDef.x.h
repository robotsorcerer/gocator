...
#define GO_SDK_PROTOCOL_VERSION    "101.5.0.0"
...
kDeclareEnum(Go, GoSurfaceRivetType, kValue)
...
kDeclareValue(Go, GoElementBool, kValue)
...
#define GO_EXT_PARAM_TYPE_SURFACE_REGION_3D            (6)
