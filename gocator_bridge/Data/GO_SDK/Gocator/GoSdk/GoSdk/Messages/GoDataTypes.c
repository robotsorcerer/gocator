...
GoFx(kStatus) GoEdgeMatchMsg_WriteV16(GoEdgeMatchMsg msg, kSerializer serializer)
{
    ...
    kCheck(kSerializer_Write32s_(serializer, (k32s)(obj->xOffset * 1000)));  
    kCheck(kSerializer_Write32s_(serializer, (k32s)(obj->yOffset * 1000)));  
    kCheck(kSerializer_Write32s_(serializer, (k32s)(obj->zAngle * 1000)));  
    kCheck(kSerializer_Write32s_(serializer, (k32s)(obj->qualityValue * 1000)));  
...
GoFx(kStatus) GoEdgeMatchMsg_ReadV16(GoEdgeMatchMsg msg, kSerializer serializer, kAlloc alloc)
{
    ...
    kTry
    {
        ...
        kTest(kSerializer_Read32s_(serializer, &temp)); 
...
GoFx(kStatus) GoBoundingBoxMatchMsg_WriteV17(GoBoundingBoxMatchMsg msg, kSerializer serializer)
{
    ...
    kCheck(kSerializer_Write32s_(serializer, (k32s)(obj->yOffset * 1000)));  
    kCheck(kSerializer_Write32s_(serializer, (k32s)(obj->zAngle * 1000)));  
    kCheck(kSerializer_Write32s_(serializer, (k32s)(obj->widthValue * 1000)));  
    kCheck(kSerializer_Write8u_(serializer, obj->widthDecision));  
    kCheck(kSerializer_Write32s_(serializer, (k32s)(obj->lengthValue * 1000)));  
...
GoFx(kStatus) GoEllipseMatchMsg_WriteV18(GoEllipseMatchMsg msg, kSerializer serializer)
{
    ...
    kCheck(kSerializer_Write32s_(serializer, (k32s)(obj->yOffset * 1000)));  
    kCheck(kSerializer_Write32s_(serializer, (k32s)(obj->zAngle * 1000)));  
    kCheck(kSerializer_Write32s_(serializer, (k32s)(obj->minorValue * 1000)));  
    kCheck(kSerializer_Write8u_(serializer, obj->minorDecision));  
    kCheck(kSerializer_Write32s_(serializer, (k32s)(obj->majorValue * 1000)));
