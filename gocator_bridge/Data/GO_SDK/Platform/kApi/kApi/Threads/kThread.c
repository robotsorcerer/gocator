...
kFx(kStatus) kThread_Init(kThread thread, kType type, kAlloc allocator)
{
    ...
    kAtomic32s_Exchange(&obj->exitCode, kOK); 
                             ...
                             kSize stackSize, const kChar* name, k32s priority)
{
    ...
    {    
        ...
        obj->id = taskSpawn(nameBuffer, osPriority, kTHREAD_DEFAULT_OPTIONS, osStackSize, kThread_EntryPoint, (_Vx_usr_arg_t)thread, 0, 0, 0, 0, 0, 0, 0, 0, 0); 
