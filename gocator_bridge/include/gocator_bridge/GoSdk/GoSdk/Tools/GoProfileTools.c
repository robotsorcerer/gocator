...
kBeginClass(Go, GoProfileBridgeValue, GoProfileTool)
...
{
    GoProfileBridgeValueClass* obj = GoProfileBridgeValue_Cast_(tool);
...
kBeginClass(Go, GoProfileXLine, GoProfileTool)
...
{
    GoProfileXLineClass* obj = GoProfileXLine_Cast_(tool);
