...
kDeclareClass(Go, GoProfileBridgeValue, GoProfileTool)

#define GoProfileBridgeValue_Cast_(CONTEXT)    kCastClass_(GoProfileBridgeValue, CONTEXT)
...
kDeclareClass(Go, GoProfileXLine, GoProfileTool)

#define GoProfileXLine_Cast_(CONTEXT)    kCastClass_(GoProfileXLine, CONTEXT)
